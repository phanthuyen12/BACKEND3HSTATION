-- Migration: Add separate columns for Nodeverse container details to nodeverse_vps_instances

ALTER TABLE nodeverse_vps_instances
ADD COLUMN container_id VARCHAR(100) NULL AFTER nodeverse_device_id,
